...
def make_angles(num_angles):
    return np.linspace(0,360, num_angles+1)[:-1]

##### TO CREATE A SERIES OF PICTURES
def make_views(ax,angles,elevation=None, width=10, height=10,
...
##### MAIN FUNCTION
def rotanimate(ax, num_angles, output, **kwargs):
    """
    ...
    Args:
        ...
        num_angles (int): the number of angles to show the plot.
    ...
    files = make_views(ax,make_angles(num_angles), **kwargs)
